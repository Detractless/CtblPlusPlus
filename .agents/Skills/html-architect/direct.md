...
This phase produces data for the pipeline. `related_actions` and `fix` fields are recommendations for the user — do not execute them. Return findings to SKILL_html-architect.md for verdict assembly.
