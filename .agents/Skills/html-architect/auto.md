...
Each script checks exactly one thing. Run them with `node <script> <target_dir>`. Every script outputs JSON findings in the Universal Finding Format defined in SKILL.md.
